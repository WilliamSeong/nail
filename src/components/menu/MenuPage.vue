      ...
      <div class="menu-body">
        ...
        <div class="menu-right">
          ...
          <div class="menu-waxing">
            ...
            <Item name="Brazilian Bikini (Take It off All)" price="42"/>
...
<style>
  ...
  *{
  ...
  .menu-head{
    background: rgb(74, 93, 63);
    background-image: linear-gradient(to right,rgb(74, 93, 63), rgb(114, 135, 101));
    width: 90%;
    height: 10%;
    display: flex;
    align-items: center;
